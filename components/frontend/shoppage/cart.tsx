...
//   const handleAddItem = (item: { id: number; title: string; salePrice: number; qty: number,imageUrl:string }) => {
//     dispatch(addItem(item));
//   };
...
//     return cartItems.reduce((total: any, item: any) => total + item.price * item.qty, 0);
//   };
...
//                     <Laabel htmlFor="free-shipping">Free shipping</Laabel>
//                   </div>
//                   <span>$0.00</span>
//                 </div>
//                 <div className="flex items-center justify-between">
...
//                 <span className="ml-1 font-medium text-red-700">$3.39</span>
//               </div>
...
//             <div className="mt-1 flex items-center justify-between">
//               <div>
//                 <span className="font-medium text-red-700">$17.99</span>
//               </div>
//               <Button size="sm" variant="outline" className="h-8 w-8 p-0">
//                 <Plus className="h-4 w-4" />
//               </Button>
...
//             <div className="mt-1 flex items-center justify-between">
//               <div>
//                 <span className="font-medium text-red-700">$29.95</span>
//               </div>
//               <Button size="sm" variant="outline" className="h-8 w-8 p-0">
//                 <Plus className="h-4 w-4" />
//               </Button>
...
//                 <span className="ml-1 font-medium text-red-700">$39.99</span>
//               </div>
//               <Button size="sm" variant="outline" className="h-8 w-8 p-0">
//                 <Plus className="h-4 w-4" />
//               </Button>
